...
public class FoodDeliveryService {
    ...
    static DeliverymanListInterface <DeliveryMan> TemporaryList = new DeliverymanList<>();
    static DeliverymanListInterface <DeliveryMan> SortedList = new DeliverymanList<>();
    static DeliveryListInterface<Delivery> delivery = new DeliveryListImplementation<>();
    static ListInterface<Payment> payment = new ListImplementation<>();
    ...
    public void hardcode(){
        ...
        list.add(new DeliveryMan("DM"+1, "Quek Wei Jian   ", "Working", 20, 5, 3000.55, "012-3456789", "Quek Address", "Available", 1, 10));
	list.add(new DeliveryMan("DM"+2, "Phuah Wai Yan   ", "Working", 18, 3, 4500.99, "012-9876543", "Phuah Address", "Available", 2, 20));
	list.add(new DeliveryMan("DM"+3, "Ng Yih Sam      ", "Working", 25, 15, 7600.30, "012-9786543", "Sam Address", "Unavailable", 3, 30));
	list.add(new DeliveryMan("DM"+4, "Seong Jian Sheng", "Working", 22, 7, 2000.55, "012-3456789", "Seong Address", "Available", 4, 40));
        
        for (int i =0;i<list.size();i++){
            
              
           DeliveryMan deliveryman = (DeliveryMan)list.get(i);
           DeliveryMan dm = new DeliveryMan();
           
            dm.setName(deliveryman.getName());
            dm.setStatus(deliveryman.getStatus());
            dm.setAge(deliveryman.getAge());
            dm.setNumberOfDelivery(deliveryman.getNumberOfDelivery());
            dm.setSalary(deliveryman.getSalary());
            dm.setAddress(deliveryman.getAddress());
            dm.setPhoneNumber(deliveryman.getPhoneNumber());
            dm.setTaskStatus(deliveryman.getTaskStatus());
            dm.setExperience(deliveryman.getExperience());
            dm.setId(deliveryman.getId());
            dm.setDistanceTravel(deliveryman.getDistanceTravel());
            
            TemporaryList.add(dm);
